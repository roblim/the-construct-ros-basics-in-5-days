...
(cl:in-package custom_age_msg_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Age>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Age)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_age_msg_pkg-msg:<Age> is deprecated: use custom_age_msg_pkg-msg:Age instead.")))

(cl:ensure-generic-function 'years-val :lambda-list '(m))
(cl:defmethod years-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_age_msg_pkg-msg:years-val is deprecated.  Use custom_age_msg_pkg-msg:years instead.")
  (years m))

(cl:ensure-generic-function 'months-val :lambda-list '(m))
(cl:defmethod months-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_age_msg_pkg-msg:months-val is deprecated.  Use custom_age_msg_pkg-msg:months instead.")
  (months m))

(cl:ensure-generic-function 'days-val :lambda-list '(m))
(cl:defmethod days-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_age_msg_pkg-msg:days-val is deprecated.  Use custom_age_msg_pkg-msg:days instead.")
  (days m))
